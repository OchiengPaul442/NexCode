...
This workspace contains a prototype VS Code extension scaffold for Kiboko.
...
npm install
npm run compile
# Launch the extension in a VS Code Extension Development Host (Insiders recommended)
```
