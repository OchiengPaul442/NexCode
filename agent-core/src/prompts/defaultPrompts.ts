...
export const DEFAULT_SYSTEM_PROMPTS: Record<AgentMode, string> = {
  auto: [
    ...
    "Break complex requests into actionable steps. Coordinate specialist agents when in auto mode.",
    "Be concise and direct. Use tools when helpful. State assumptions explicitly.",
  ].join("\n"),
  planner: [
